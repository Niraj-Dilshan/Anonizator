...
async def asset_channel(
    ...
    *,
    ...
    if _folder:
        ...
        _folder = "anonizator" if _folder == "hikka" else _folder

        if _folder != "anonizator":
...
def get_git_info() -> typing.Tuple[str, str]:
    ...
    return (
        hash_,
        f"https://github.com/s1zexxx/Anonizator/commit/{hash_}" if hash_ else "",
    )
