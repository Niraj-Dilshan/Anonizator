...
class TestMod(loader.Module):
    ...
    strings = {
        ...
        "logs_caption": (
            "<emoji document_id=5384307092599348179>🫡</emoji> <b>Anonizator logs with"
    ...
    strings_ru = {
        ...
        "logs_caption": (
            "<emoji document_id=5384307092599348179>🫡</emoji> Логи <b>Anonizator</b> уровня"
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                " logs from TestModule. If this option is enabled, Anonizator will send all"
    ...
    async def logs(
        ...
        other = (
            *main.netver,
            (
                " <a"
                f' href="https://github.com/s1zexxx/Anonizator/commit/{ghash}">@{ghash[:8]}</a>'
                if ghash
                else ""
            ),
        )
    ...
    async def client_ready(self):
        chat, _ = await utils.asset_channel(
            self._client,
            "anonizator-logs",
            "🌘 Your Anonizator logs will appear in this chat",
            silent=True,
            invite_bot=True,
