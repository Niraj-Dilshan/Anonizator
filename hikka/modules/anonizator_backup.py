...
@loader.tds
class AnonizatorBackupMod(loader.Module):
    """Automatic database backup"""

    strings = {
        "name": "AnonizatorBackup",
        "period": (
    ...
    strings_ru = {
        "period": (
            ...
            "</b>‼️<b> Не с кем не делитесь файлами конфига, даже с разработчиками Anonizator! Они содержат конфиденциальные данные\n\n"
    ...
    async def client_ready(self):
        if not self.get("period"):
            await self.inline.bot.send_photo(
                self.tg_id,
                photo="https://github.com/s1zexxx/Anonizator/raw/stable/assets/BackUp.png",
    ...
    async def handler(self):
        try:
            ...
            backup.name = "anonizator-db-backup-{}.json".format(
            ...
            logger.exception("AnonizatorBackup failed")
