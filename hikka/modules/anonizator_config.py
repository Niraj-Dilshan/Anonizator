...
@loader.tds
class AnonizatorConfigMod(loader.Module):
    """Interactive configurator for Anonizator Userbot"""

    strings = {
        "name": "AnonizatorConfig",
    ...
    strings_ru = {
        ...
        "_cls_doc": "Интерактивный конфигуратор Anonizator",
    ...
    strings_uk = {
        ...
        "_cls_doc": "Інтерактивний конфігуратор Anonizator",
