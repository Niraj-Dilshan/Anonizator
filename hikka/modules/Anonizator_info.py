...
@loader.tds
class AnonizatorInfoMod(loader.Module):
    """Show userbot info"""
    ...
    strings = {
        ...
        "desc": (
            ...
            ' href="https://github.com/s1zexxx/Anonizator">GitHub</a>'
        ),
    }
    ...
    strings_ru = {
        ...
        "desc": (
            "<emoji document_id=5062291541624619917>😀</emoji> <b>anonizator</b>"
            " Юзербот, основанный на Hikka с богатым функционалом."
            " Юзербот работает во всех чатах от имени твоего аккаунта. <b>Исходный код anonizator можешь всегда посмотреть на <a"
            ' href="https://github.com/s1zexxx/Anonizator>GitHub</a>'
        ),
    }
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "banner_url",
                "https://github.com/s1zexxx/Anonizator/raw/main/assets/Anonizator_info.mp4",
    ...
    async def client_ready(self):
        ...
        if self.config["banner_url"] == "https://github.com/s1zexxx/Anonizator/raw/main/assets/Anonizator_info.mp4":
            self.config["banner_url"] = "https://github.com/s1zexxx/Anonizator/raw/main/assets/Anonizator_info.mp4"
    ...
    def _render_info(self, inline: bool) -> str:
        ...
        return (
            ...
            if self.config["custom_message"]
                ...
                f"<b>{{}} for {me}</b>\n\n"
                f"<emoji document_id=5294411666157478650>☸️</emoji> <b>{self.strings('version')}:</b> {_version}\n"
                f"<emoji document_id=6296577138615125756>✅</emoji> <b>{self.strings('prefix')}:</b> {prefix}\n"
                f"<emoji document_id=6219882697884436514>🐋</emoji> <b>{self.strings('uptime')}:</b>"
                f" {utils.formatted_uptime()}\n\n"
                f"<emoji document_id=5785379836008598919>📱</emoji> <b>{platform}"
                f"{usage}"
            ).format(
                *map(
    ...
    async def Info(self, _: InlineQuery) -> dict:
        ...
        return {
            ...
            **(
            ...
            "thumb": (
                "https://github.com/s1zexxx/Anonizator/raw/main/assets/bot_pfp.png"
            ),
    ...
    @loader.command(ru_doc="Отправить информацию по типу 'Что такое Anonizator?'",)
    async def whoanonizator(self, message: Message):
        """Send info aka 'What is anonizator?'"""
