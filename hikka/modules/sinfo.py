...
#
# ---------------------------------------------------------------------------------
#     ▀▄   ▄▀   👾 Module for Anonizator UserBot (based on Hikka 1.6.0)
#    ▄█▀███▀█▄  🔒 Licensed under the GNU GPLv3
#   █▀███████▀█ ⚠️ @DarkModules & @Anonizator
#   █ █▀▀▀▀▀█ █
#      ▀▀ ▀▀
# ---------------------------------------------------------------------------------
# Name: SysInfo
# Description: Show system info
# Author: Anonizator Team
# Commands:
# .sinfo
# ---------------------------------------------------------------------------------
...
class SysInfoMod(loader.Module):
    """Simple System Info for Anonizator UserBot (And Hikka Support)"""
