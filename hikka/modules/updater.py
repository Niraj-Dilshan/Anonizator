...
class UpdaterMod(loader.Module):
    ...
    strings = {
        ...
        "update_confirm": (
            "❓ <b>Are you sure you"
            " want to update?\n\n<a"
            ' href="https://github.com/s1zexxx/Anonizator/{}">{}</a> ⤑ <a'
            ' href="https://github.com/s1zexxx/Anonizator/{}">{}</a></b>'
        ),
    ...
    strings_ru = {
        ...
        "update_confirm": (
            "❓ <b>Ты уверен, что"
            " хочешь обновиться??\n\n<a"
            ' href="https://github.com/s1zexxx/Anonizator/commit/{}">{}</a> ⤑ <a'
            ' href="https://github.com/s1zexxx/Anonizator/commit/{}">{}</a></b>'
        ),
...
#            ),
    ...
    async def _add_folder(self):
        ...
        try:
            ...
            logger.critical(
                "Can't create Anonizator folder. Possible reasons are:\n"
