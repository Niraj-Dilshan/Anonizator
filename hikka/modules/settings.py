...
class CoreMod(loader.Module):
    ...
    strings = {
        ...
        "prefix_collision": (
            "<emoji document_id=5469654973308476699>💣</emoji> <b>Your Dragon and Anonizator"
    ...
    strings_ru = {
        ...
        "prefix_collision": (
            "<emoji document_id=5469654973308476699>💣</emoji> <b>Префиксы Dragon и Anonizator"
            " Anonizator должны отличаться!</b>"
        ),
    }
    ...
    strings_uk = {
        ...
        "prefix_collision": (
            ...
            " Anonizator повинні відрізнятися!</b>"
        ),
    }
    ...
    @loader.command(
        ru_doc="Показать версию Anonizator",
    )
    async def anonizatorcmd(self, message: Message):
        """Get Anonizator version"""
        await utils.answer_file(
            message,
            "https://github.com/s1zexxx/Anonizator/raw/stable/assets/banner.png",
            self.strings("anonizator").format(
                (
                    (
