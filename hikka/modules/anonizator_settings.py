...
@loader.tds
class AnonizatorSettingsMod(loader.Module):
    """Advanced settings for Anonizator Userbot"""

    strings = {
        "name": "AnonizatorSettings",
        "watchers": (
        ...
        "inline_settings": "⚙️ <b>Here you can configure your Anonizator settings</b>",
        "confirm_update": (
        ...
        "nonick_warning": (
            ...
            "You may get muted in Anonizator chats. Change prefix or "
            "disable NoNick!"
        ),
        "reply_required": (
        ...
        "deauth_confirm": (
            "⚠️ <b>This action will fully remove Anonizator from this account and can't be"
            " reverted!</b>\n\n<i>- Anonizator chats will be removed\n- Session will be"
            " terminated and removed\n- Anonizator inline bot will be removed</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Are you really sure you want to delete Anonizator?</b>"
        ),
        "deauth_yes": "I'm sure",
        ...
        "uninstall": "😢 <b>Uninstalling Anonizator...</b>",
        "uninstalled": (
            "😢 <b>Anonizator uninstalled. Web interface is still active, you can add another"
            " account</b>"
        ),
        "cmd_nn_list": (
        ...
        "privacy_leak": (
            "⚠️ <b>This command gives access to your Anonizator web interface. It's not"
        ...
        "opening_tunnel": "🔁 <b>Opening tunnel to Anonizator web interface...</b>",
        "tunnel_opened": "🎉 <b>Tunnel opened. This link is valid for about 1 hour</b>",
        "web_btn": "🌍 Web interface",
        "btn_yes": "🚸 Open anyway",
        "btn_no": "🔻 Cancel",
        "lavhost_web": (
            "✌️ <b>This link leads to your Anonizator web interface on lavHost</b>\n\n<i>💡"
    ...
    strings_ru = {
        ...
        "inline_settings": "⚙️ <b>Здесь можно управлять настройками Anonizator</b>",
        ...
        "_cls_doc": "Дополнительные настройки Anonizator",
        "nonick_warning": (
            "Внимание! Ты включил NoNick со стандартным префиксом! "
            "Тебя могут замьютить в чатах Anonizator. Измени префикс или "
        ...
        "deauth_confirm": (
            "⚠️ <b>Это действие полностью удалит Anonizator с этого аккаунта! Его нельзя"
            " отменить</b>\n\n<i>- Все чаты, связанные с Anonizator будут удалены\n- Сессия"
            " Anonizator будет сброшена\n- Инлайн бот Anonizator будет удален</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Ты точно уверен, что хочешь удалить Anonizator?</b>",
        "deauth_yes": "Я уверен",
        ...
        "uninstall": "😢 <b>Удаляю Anonizator...</b>",
        "uninstalled": (
            "😢 <b>Anonizator удалён. Веб-интерфейс все еще активен, можно добавить другие"
            " аккаунты!</b>"
        ),
        "cmd_nn_list": (
        ...
        "privacy_leak": (
            "⚠️ <b>Эта команда дает доступ к веб-интерфейсу Anonizator. Ее выполнение в"
        ...
        "opening_tunnel": "🔁 <b>Открываю тоннель к веб-интерфейсу Anonizator...</b>",
        "tunnel_opened": (
        ...
        "btn_no": "🔻 Закрыть",
        "lavhost_web": (
            "✌️ <b>По этой ссылке ты попадешь в веб-интерфейс Anonizator на"
    ...
    async def _uninstall(self, call: InlineCall):
        ...
        async for dialog in self._client.iter_dialogs(
            ...
            if (
                ...
                and (
                    ...
                    and dialog.name in {"anonizator-logs", "silent-tags"}
                )
                or (
        ...
        if any(folder.title == "anonizator" for folder in folders):
            folder_id = max(
                folders,
                key=lambda x: x.id,
            ).id
    ...
    @loader.owner
    @loader.command(ru_doc="Удалить Anonizator")
    async def uninstall_anonizator(self, message: Message):
        """Uninstall Anonizator"""
    ...
    @loader.owner
    @loader.command(ru_doc="Открыть тоннель к веб-интерфейсу Anonizator")
    async def weburl(self, message: Message, force: bool = False):
        """Opens web tunnel to your Anonizator web interface"""
