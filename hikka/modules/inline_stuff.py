...
class InlineStuffMod(loader.Module):
    ...
    strings = {
        ...
        "this_is_hikka": (
            "🎈 <b>Hi! This is Anonizator, UserBot that is based on the best UserBot Hikka. You can"
            " install it to your account!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/s1zexxx/Anonizator">GitHub</a></b>\n<b>🎈 <a'
            ' href="https://t.me/ZAREYblU_CHAT">Чат поддержки</a></b>'
        ),
    }
    ...
    strings_ru = {
        ...
        "bot_updated": (
            ...
            " Для их применения нужно перезагрузить Anonizator</b>"
        ),
        "this_is_hikka": (
            "🎈 <b>Привет! Это Anonizator, ЮзерБот основанный на Hikka. Вы можете"
    ...
    strings_uk = {
        ...
        "bot_updated": (
            ...
            " Для їх застосування потрібно перезавантажити Anonizator</b>"
        ),
        "this_is_hikka": (
            "🎈 <b>Привіт! Це Anonizator, заснований на Hikka. Ви можете"
            " встановити на свій аккаунт!</b>\n\n<b>💎 <a"
            ' href="https://github.com/s1zexxx/Anonizator">GitHub</a></b>\n<b>🎈 <a'
            ' href="https://t.me/ZAREYblU_CHAT">Чат підтримки</a></b>'
        ),
    }
    ...
    async def ch_anonizator_bot(self, message: Message):
        """<username> - Change your Anonizator inline bot username"""
    ...
    async def aiogram_watcher(self, message: BotInlineMessage):
        ...
        await message.answer_photo(
            "https://github.com/s1zexxx/Anonizator/raw/Dev/assets/banner.png",
