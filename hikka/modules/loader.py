...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "inline_init_failed": (
            ...
            " Anonizator inline feature and initialization of InlineManager"
    ...
    strings_ru = {
        ...
        "inline_init_failed": (
            ...
            " AnonizatorInline, а инициализация менеджера инлайна неудачна</b>\n<i>Попробуй"
    ...
    async def load_module(
        ...
        if re.search(r"# ?scope: ?anonizator_min", doc):
            ver = re.search(r"# ?scope: ?anonizator_min ((?:\d+\.){2}\d+)", doc).group(1)
