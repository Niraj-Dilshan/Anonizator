...
class HelpMod(loader.Module):
    ...
    strings = {
        ...
        "undoc": "🦥 No docs",
        "support": (
            "{}\n\n <b>Link to</b> <a href='https://t.me/ZAREYblU_CHAT'>support chat</a></b>"
        ),
        "not_exact": (
            "<emoji document_id=5312383351217201533>☝️</emoji> <b>No exact match"
            " occured, so the closest result is shown instead</b>"
        ),
        "request_join": "You requested link for Anonizator support chat",
        "core_notice": (
    ...
    strings_ru = {
        "undoc": "🦥 Нет описания",
        "support": (
            "{}\n\n <b>Ссылка на</b> <a href='https://t.me/ZAREYblU_CHAT'>чат помощи</a></b>"
        ),
        ...
        "request_join": "Вы запросили ссылку на чат помощи Anonizator",
        "core_notice": (
    ...
    strings_uk = {
        "undoc": "🦥 Немає опису",
        "support": (
            "{}\n\n <b>Посилання на</b> <a href='https://t.me/ZAREYblU_CHAT'>чат допомоги</a></b>"
        ),
        ...
        "request_join": "Ви запросили посилання на чат допомоги Anonizator",
        "core_notice": (
    ...
    @loader.command(ru_doc="Показать ссылку на чат помощи Anonizator")
    async def support(self, message):
        """Get link of Anonizator support chat"""
        if message.out:
            await self.request_join("@ZAREYblU_CHAT", self.strings("request_join"))
